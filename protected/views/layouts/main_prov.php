  ...
  <header>
  	<nav>
        ...
        <li class="menu-group">
          ...
          <ul>
            <li class="disabled"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/formunggah">Unggah LPLPO</a></li>
            <li class="disabled"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/formunggah">Unggah Non LPLPO</a></li>
            <li class="disabled">
              <a class="dropdown2" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/daftarunggahkab">Daftar Unggah</a>
              <ul>
        ...
        <div class="stick-right">
          <li class="menu-group">
            <a class="dropdown" href="">DKI Jakarta</a>
            <ul>
          ...
          <li>
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/index" class="logout">logout</a>
          </li>
        </div>
      </ul>
    </nav>
  ...
  <div class="container">
    <div class="r-row wrapper" id="wrapper">
      <div class="large-2 column left">
        <ul class="side-menu">
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Ketersediaan Obat</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">RKO</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Riwayat Unggah</a>
          </li>
          <li class="">
            <a class="multi" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Unggah Laporan</a><div class="showoption" onclick="document.getElementById('multi1').style.display='block'"></div>
            <ul id="multi1" class="hide">
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Penerimaan Obat</a></li>
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">LPLPO</a></li>
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Non LPLPO</a></li>
            </ul>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Perencanaan Provinsi</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">Penyesuaiam Rencana kabupaten</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/pilihobat">UKP4</a>
          </li>
        </ul> 
      </div>
