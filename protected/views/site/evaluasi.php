...
?>
      <div>
        <div>
          ...
          <form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/">
            <div class="form-row">
              <button class="btn push170 green" type="submit" formaction="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/unggahukp4">Kembali</button>
            </div>
            <div class="form-row">
            </div>
          </form>
