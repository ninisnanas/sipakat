  ...
  <div class="container">
    <div class="r-row wrapper" id="wrapper">
      <div class="large-2 column left">
        <ul class="side-menu">
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">UKP4</a>
            <ul>
              <li>
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/pilihobat">Pilih Obat</a>
              </li>
              <li>
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/riwayatukp4">Riwayat</a>
              </li>
            </ul>
          </li>
          <li class="">
          ...
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">RKO</a>
          </li>
        </ul> 
      </div>
