  ...
  <header>
  	<nav>
        ...
        <div class="stick-right">
          <li class="menu-group">
            <a class="dropdown" href="">Jakarta Pusat</a>
            <ul>
  ...
  <div class="container">
    <div class="r-row wrapper" id="wrapper">
      <div class="large-2 column left">
        <ul class="side-menu">
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Daftar LPLPO</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Ketersediaan Obat</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Kedaluwarsa Obat</a>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Riwayat Unggah</a>
          </li>
          <li class="">
            <a class="multi" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Unggah Laporan</a><div class="showoption" onclick="document.getElementById('multi1').style.display='block'"></div>
            <ul id="multi1" class="hide">
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Penerimaan Obat</a></li>
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">LPLPO</a></li>
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Non LPLPO</a></li>
            </ul>
          </li>
          <li class="">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=">Daftar Puskesmas</a>
          </li>
        </ul> 
      </div>
